                ...
                <div class="card-body">
                    ...
                    <form action="/jobs" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="hiringManager" class="form-control" type="text" name="hiringManager"  value="" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="moduleCode" class="form-control" type="text" name="moduleCode"  value=""  required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="jobDescription" class="form-control" type="text" name="jobDescription"  value=""  required></textarea>

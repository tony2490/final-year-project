<!-- this page displays all the status unsucessful applications allows for admins to filter through modules and status and view applications  -->
@extends('layouts.app')
...
<div class="table-responsive">
  ...
  if($myApplication->status == "Unsuccessful") :?>
